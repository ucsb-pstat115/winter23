...
include_graphics("lab10/8schools1.JPG")
```

```{r, echo=FALSE, out.width = '80%'}
include_graphics("lab10/8schools2.JPG")
```
...
```{r, echo=FALSE, out.width = '80%'}
include_graphics("lab10/8schools3.JPG")
```
...
library(cmdstanr)
install_cmdstan()
stan_model <- cmdstan_model("lab10/eight_schools.stan")
