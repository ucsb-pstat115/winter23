...
- Let $X_1, X_2,\dots, X_n$  $i.i.d \sim N(\mu,\sigma^2)$ with known variance.
$$
\begin{aligned}
...
& = \left(2\pi \sigma^2\right)^{-\frac{n}{2}}\exp{\left(-\frac{1}{2\sigma^2}\left(\sum_{i=1}^{n} x_{i}^{2}-2\mu \sum_{i=1}^{n}x_i +n\mu^2  \right)\right)}\\
&= \left(2\pi \sigma^2\right)^{-\frac{n}{2}}\exp{\left(-\frac{1}{2\sigma^2}\sum_{i=1}^{n} x_{i}^{2} \right)}\exp{\left(-\frac{1}{2\sigma^2}\left(-2\mu \sum_{i=1}^{n}x_i +n\mu^2  \right)\right)} \\
& = g(T, (\mu, \sigma^2)) h(x_1,...,x_n)
\end{aligned}
$$
...
and 
$$
h(x_1,...,x_n) = \left(2\pi \sigma^2\right)^{-\frac{n}{2}}\exp{\left(-\frac{1}{2\sigma^2}\sum_{i=1}^{n} x_{i}^{2} \right)}
$$
...
- Was this what you expected?
    + The probability of no error seems high. Radom is a city in Poland though. Maybe it is a more
popular topic of discussion than we might expect?
